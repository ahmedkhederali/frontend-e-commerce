...
const ProductEditModal = ({ isOpen, onClose, isEdit, currentId ,addedProd,setAddedProd}) => {
    ...
    const { values, isValid, handleChange, handleSubmit, resetForm} = useFormik({
        ...
        onSubmit: values => {
            try { 
                addProduct(imageUrl, values.name, values.color, values.sizes, values.description, values.category, values.gender, values.price,values.stock)
                .then((result) => {
                    if (result.status) {
                        toast({
                            title: 'Error!',
    ...
    const onClickSave = () => {
        updateProduct(currentId, name, description, price,stock)
            .then((result) => {
                if (result.status) {
                    toast({
                        title: 'Error!',
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <Input mt={3} placeholder='Stock' type='number' onInput={(e) => setStock(e.target.value)} value={stock} />
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <Input mt={3} placeholder='Stock' type='number' name='stock' onChange={handleChange} value={values.stock} />
